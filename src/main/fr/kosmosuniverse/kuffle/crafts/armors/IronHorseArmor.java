package main.fr.kosmosuniverse.kuffle.crafts.armors;
...
public class IronHorseArmor extends ACrafts {
	MaterialChoice mc;
	
	public IronHorseArmor() {
		name = "IronHorseArmor";
		
		recipe = new ShapedRecipe(new NamespacedKey(KuffleMain.current, name), new ItemStack(Material.IRON_HORSE_ARMOR));
		...
		((ShapedRecipe) recipe).shape("RRI", "IWI", "III");
		((ShapedRecipe) recipe).setIngredient('I', Material.IRON_INGOT);
