...
public class BubbleCoralBlock extends ACrafts {
	public BubbleCoralBlock() {
		...
		item = new ItemStack(Material.BUBBLE_CORAL_BLOCK);
	}
	...
	public Inventory getInventoryRecipe() {
		...
		for (int i = 0; i < 27; i++) {
			if (i == 0) {
				...
				inv.setItem(i, ItemUtils.itemMakerName(Material.BUBBLE_CORAL, 1, "Bubble Coral or Bubble Coral Fan"));
			} else if (i == 14 || i == 21 || i == 22 || i == 23) {
				inv.setItem(i, ItemUtils.itemMakerName(Material.BUBBLE_CORAL_FAN, 1, "Bubble Coral or Bubble Coral Fan"));
			} else if (i == 13) {
