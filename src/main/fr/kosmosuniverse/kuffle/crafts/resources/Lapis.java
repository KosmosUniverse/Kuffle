...
public class Lapis extends ACrafts {
	...
	public Lapis() {
		...
		recipe = new ShapelessRecipe(new NamespacedKey(KuffleMain.current, name), new ItemStack(Material.LAPIS_LAZULI, 6));
		...
		item = new ItemStack(Material.LAPIS_LAZULI, 6);
	}
	
	public Inventory getInventoryRecipe() {
		Inventory inv = Bukkit.createInventory(null,  27, "�8" + name);
		ItemStack customOre = mc.getChoices().size() > 1 ? ItemUtils.itemMakerName(Material.LAPIS_ORE, 1, ChatColor.BLUE + "Any" + ChatColor.GREEN + " Lapis " + ChatColor.RED + "Ore") : new ItemStack(Material.LAPIS_ORE);
